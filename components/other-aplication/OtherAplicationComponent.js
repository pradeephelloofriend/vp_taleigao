...
import OtherAplicationTabDetailComponent from './OtherAplicationTabDetailComponent';
import SpinningComponent from '../spin/SpinningComponent';
const { TabPane } = Tabs;
const OtherAplicationComponent = ({tabKey,routeTitle,menuData,cDetailData,routeUri,setTabKey}) => {
                                ...
                                {mData!==null?mData.childItems.edges.map((t,idx)=>
                                    <TabPane tab={t.node.label} key={t.node.uri}>
                                        <div className='page-content'>
                                            ...
                                            {crData!==null?
                                            <OtherAplicationTabDetailComponent cDetailData={crData}/>
...
export default connect(mapStateToProps,mapDispatchToProps) (OtherAplicationComponent)